...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navItems = [
    { path: '/admin/dashboard', label: 'Chat Agent', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z' },
    { path: '/admin/inbox', label: 'Kotak Masuk', icon: 'M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4' },
    { path: '/admin/knowledge', label: 'Basis Data (Knowledge)', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
    { path: '/admin/agents', label: 'Kelola Agent', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
    { path: '/admin/settings', label: 'Pengaturan', icon: 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z' },
  ];
      ...
      <aside className="w-64 bg-slate-800 border-r border-slate-700 flex flex-col hidden md:flex">
        <div className="p-6 flex items-center gap-3">
          ...
          <div>
              ...
              <p className="text-xs text-slate-400 font-medium">Master Admin</p>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-slate-700 bg-slate-800/50">
            <button 
                ...
                className="w-full flex items-center justify-center gap-2 bg-red-600/10 hover:bg-red-600 text-red-400 hover:text-white py-2 rounded-lg transition-colors text-sm font-bold"
            >
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 bg-slate-800/90 backdrop-blur-md p-4 z-50 flex justify-between items-center border-b border-slate-700 h-20">
          ...
          <div className="flex space-x-1 bg-slate-900/50 p-1 rounded-lg border border-slate-700/50">
             {navItems.map(item => (
              ...
              <button onClick={handleLogout} className="p-2 text-red-400 hover:text-white">
      ...
      {rotationToast.show && (
        <div className="fixed bottom-6 right-6 z-[9999] animate-bounce-in">
          <div className="bg-slate-800 border-l-4 border-blue-500 shadow-2xl rounded-lg p-4 flex items-center gap-4 min-w-[240px]">
            ...
            <div>
              <p className="text-sm font-bold text-white">Rotasi API</p>
              <p className="text-xs text-slate-400">Beralih ke Key {rotationToast.index}...</p>
            </div>
            <button 
